...
import { AddUserReaction, DeleteUserReaction } from '../../../../API/Reaction'
...
const PostActions = ({
  ...
  const GetSelectedReactionId = (ReactionType) => {
    const SelectedReaction = UserReactions.find(
      (u) => u.ReactionType == ReactionType
    )
      ...
      <div className="flex justify-between items-center">
        <div className="flex space-x-3 *:text-sm">
          ...
          <button
            ...
            onClick={() =>
              handleSelectReaction(UserReactions[0]['ReactionType'])
            }
          >
            <span className="hover:scale-150 duration-300 block">👍</span>{' '}
          ...
          <button
            ...
            onClick={() =>
              handleSelectReaction(UserReactions[1]['ReactionType'])
            }
          >
            <span className="hover:scale-150 duration-300 block">❤️</span>{' '}
          ...
          <button
            className="flex items-end justify-center gap-0.5 text-gray-600 hover:text-blue-600 dark:text-gray-300"
            onClick={() =>
              handleSelectReaction(UserReactions[5]['ReactionType'])
            }
          >
            <span className="hover:scale-150 duration-300 block">👎</span>{' '}
          ...
          <button
            ...
            onClick={() =>
              handleSelectReaction(UserReactions[2]['ReactionType'])
            }
          >
            <span className="hover:scale-150 duration-300 block">😮</span>{' '}
            <span className="text-xs">{wows}</span>
          </button>
          ...
          <button
            className="flex items-end justify-center gap-0.5 text-gray-600 hover:text-blue-600 dark:text-gray-300"
            onClick={() =>
              handleSelectReaction(UserReactions[3]['ReactionType'])
            }
          >
            <span className="hover:scale-150 duration-300  block">😢</span>{' '}
            <span className="text-xs">{sads}</span>
          </button>
          ...
          <button
            className="flex items-end justify-center gap-0.5 text-gray-600 hover:text-red-600 dark:text-gray-300"
            onClick={() =>
              handleSelectReaction(UserReactions[4]['ReactionType'])
            }
          >
            <span className="hover:scale-150 duration-300 block">😠</span>{' '}
            <span className="text-xs">{angrys}</span>
          </button>
        </div>
        {/* Comments Toggle */}
        <button
